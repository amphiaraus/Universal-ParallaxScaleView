...
/**
 * author : Soulwolf Create by 2015/7/22 11:29
 * email  : ToakerQin@gmail.com.
 */
public class FitListView extends ListView  implements Scrollable{

    private static final boolean DEBUG = false;

    private static final String LOG_TAG = "FitListView:";
    ...
    public FitListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
