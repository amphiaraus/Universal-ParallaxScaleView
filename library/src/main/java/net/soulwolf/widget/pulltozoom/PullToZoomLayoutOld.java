 ...
 */
public class PullToZoomLayoutOld extends ViewGroup {
    ...
    public PullToZoomLayoutOld(Context context, AttributeSet attrs) {
        super(context, attrs);
        applyAttributeSet(context,attrs,0,0);
    }

    public PullToZoomLayoutOld(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        applyAttributeSet(context,attrs,defStyleAttr,0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public PullToZoomLayoutOld(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void applyAttributeSet(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray styleArray = context.obtainStyledAttributes(attrs, R.styleable.PullToZoomLayoutOld, defStyleAttr, defStyleRes);
