...
/**
 * author: Soulwolf Created on 2015/8/7 0:05.
 * email : Ching.Soulwolf@gmail.com
 */
public final class ScrollableUtils {

    public static int getAbsListViewScrollY(AbsListView view,int headerViewCount,int minScrollY) {
